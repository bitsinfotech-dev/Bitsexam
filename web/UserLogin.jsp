    ...
    <body>                    
        <div class="container">                         
            <form action="SignIn" method="post">
                ...
                <div class="form-group">                    
                    <button type="submit" class="btn btn-success">Student Login</button>                   
                    <a style="border: thin solid white;padding: 5px; text-decoration: none;color: inherit; margin-left: 10px;" href="TeacherLogin.jsp" class="btn btn-success">Teacher Login</a>                                
                    <a href="AdminPanel/AdminLogin.jsp"><button type="button" class="btn btn-success">Admin Login</button></a>
                </div>
